...
import me.leon.plugin.LifecycleClassVisitor
import org.apache.commons.io.FileUtils
import org.objectweb.asm.ClassReader
import org.objectweb.asm.ClassVisitor
import org.objectweb.asm.ClassWriter

public class LeonTransform extends Transform {
...
//                        对class文件进行读取与解析
            ...
            //  AGP 3.6  后,R.java会单独打成Jar包,需要单独copy
            transformInput.jarInputs.forEach {
                def dest = outputProvider.getContentLocation(it.name, it.contentTypes,
